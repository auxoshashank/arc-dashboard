...
export default function PersonaPage() {
  ...
  const [selectedSegment, setSelectedSegment] = useState(personasData[0]);
  ...
  const filteredPersonas = personasData.filter((segment) =>
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex items-start justify-between mb-8 main">
          ...
          <div className="w-[300px] leftPanel fixedPanel px-6">
            <div class="flexRow">
              <h1 className="featureHeading m-top-20">Personas</h1>
            ...
            <div>
              {filteredPersonas.map((persona) => (
                ...
                >
                  ...
                  <div>
                    <img className="personaIcon" src={persona.image}/>
                  </div>
                  </div>
