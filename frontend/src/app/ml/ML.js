                ...
                (
                  <>
                    <div class="margin-10 flexRow">            
                      <div style={{width:"33%"}}>            
                        <ExpandableCard txt={jsonData["experiments_summary"]} heading={"Data Schema"} myheight={500}></ExpandableCard>            
                      </div>
                      <div style={{width:"66%"}}>
                        <div class="flexRow">
                          <div style={{width:"49%"}}>
                            {(Object.keys(jsonData).length >1) ? <ExpandableCard txt={jsonData["executive_summary"]} heading={"Business Impact Tracking"}></ExpandableCard>
                            :null}
                          </div>
                          <div style={{width:"49%"}}>
                            {(Object.keys(jsonData).length >2) ? <ExpandableCard txt={jsonData["preprocessing_steps"]}  heading={"Problem Overview"}></ExpandableCard>
                            :null}
                          </div>
                        </div>
